! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = e || self).Sweetalert2 = t() }(this, function() {
    ...
    const q = { previousBodyPadding: null },
        ...
        U = (e, t, n) => {
            var o, i;
            if (o = e, i = t, s(o.classList).forEach(e => { Object.values(g).includes(e) || Object.values(h).includes(e) || Object.values(i.showClass).includes(e) || o.classList.remove(e) }), t.customClass && t.customClass[n]) {
        ...
        ae = e => {
            var t = (() => { const e = b(); return !!e && (e.remove(), _([document.documentElement, document.body], [g["no-backdrop"], g["toast-shown"], g["has-column"]]), !0) })();
    ...
    function pe(e, t, n) { $(e, n["show".concat(o(t), "Button")], "inline-block"), V(e, n["".concat(t, "ButtonText")]), e.setAttribute("aria-label", n["".concat(t, "ButtonAriaLabel")]), e.className = g[t], U(e, n, "".concat(t, "Button")), W(e, n["".concat(t, "ButtonClass")]) }
    const me = (e, t) => {
        var n, o, i = b();
    ...
    const Ye = e => We[e],
        Ze = e => {!e.backdrop && e.allowOutsideClick && a('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'); for (const o in e) n = o, Ke(n) || a('Unknown parameter "'.concat(n, '"')), e.toast && (t = o, _e.includes(t) && a('The parameter "'.concat(t, '" is incompatible with toasts'))), t = o, Ye(t) && i(t, Ye(t)); var t, n };
    ...
    const rt = e => { e.isAwaitingPromise() && (ge.awaitingPromise.delete(e), ge.innerParams.get(e) || e._destroy()) },
        ct = (e, t, n) => {
            var o = b(),
                i = ue && te(t);
    ...
    var gt = { email: (e, t) => /^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(e) ? Promise.resolve() : Promise.resolve(t || "Invalid email address"), url: (e, t) => /^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-z]{2,63}\b([-a-zA-Z0-9@:%_+.~#?&/=]*)$/.test(e) ? Promise.resolve() : Promise.resolve(t || "Invalid URL") };
    ...
    const bt = ["swal-title", "swal-html", "swal-footer"],
        ...
        xt = e => {
            ...
            Lt(t, n, e), setTimeout(() => { St(t, n) }, 10), I() && (Tt(t, e.scrollbarPadding, o), (() => {
                const e = s(document.body.children);
        ...
        Ft = (t, n) => {
            ...
            if (e.showLoaderOnDeny && De(E()), e.preDeny) {
                ...
                o.then(e => {!1 === e ? t.hideLoading() : t.closePopup({ isDenied: !0, value: void 0 === e ? n : e }) }).catch(e => zt(t || void 0, e))
        ...
        Wt = (t, n) => {
            ...
            if (e.showLoaderOnConfirm && De(), e.preConfirm) {
                ...
                o.then(e => { G(B()) || !1 === e ? t.hideLoading() : Rt(t, void 0 === e ? n : e) }).catch(e => zt(t || void 0, e))
            } else Rt(t, n)
        },
        _t = (e, t, n) => {
            const o = M();
    ...
    let en = !1;
    const tn = t => { t.popup.onmousedown = () => { t.container.onmouseup = function(e) { t.container.onmouseup = void 0, e.target === t.container && (en = !0) } } },
    ...
    const sn = (e, t, n) => {
        ...
        cn = () => { document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur() };
    const ln = e => { e.isAwaitingPromise() ? (un(ge, e), ge.awaitingPromise.set(e, !0)) : (un(it, e), un(ge, e)) },
        un = (e, t) => { for (const n in e) e[n].delete(t) };
    e = Object.freeze({
        hideLoading: Xe,
        disableLoading: Xe,
        getInput: function(e) { var t = ge.innerParams.get(e || this); return (e = ge.domCache.get(e || this)) ? F(e.popup, t.input) : null },
        close: at,
        ...
        closeModal: at,
        closeToast: at,
        enableButtons: function() { dt(this, ["confirmButton", "denyButton", "cancelButton"], !1) },
        disableButtons: function() { dt(this, ["confirmButton", "denyButton", "cancelButton"], !0) },
        enableInput: function() { return pt(this.getInput(), !1) },
        disableInput: function() { return pt(this.getInput(), !0) },
        ...
        _main: function(e, t = {}) {
            ...
            var a, r, c, t = (e => { const t = { popup: v(), container: b(), actions: L(), confirmButton: x(), denyButton: E(), cancelButton: T(), loader: S(), closeButton: D(), validationMessage: B(), progressSteps: P() }; return ge.domCache.set(e, t), t })(this);
            return Oe(this, e), ge.innerParams.set(this, e), a = this, r = t, c = e, new Promise((e, t) => {
                const n = e => { a.closePopup({ isDismissed: !0, dismiss: e }) };
                var o, i, s;
                ...
                })(a), r.cancelButton.onclick = () => ((e, t) => { e.disableButtons(), t(l.cancel) })(a, n), r.closeButton.onclick = () => n(l.close), o = a, e = r, t = n, ge.innerParams.get(o).toast ? Qt(o, e, t) : (tn(e), nn(e), on(o, e, t)), i = a, e = Ie, t = c, s = n, e.keydownTarget && e.keydownHandlerAdded && (e.keydownTarget.removeEventListener("keydown", e.keydownHandler, { capture: e.keydownListenerCapture }), e.keydownHandlerAdded = !1), t.toast || (e.keydownHandler = e => Zt(i, e, s), e.keydownTarget = t.keydownListenerCapture ? window : v(), e.keydownListenerCapture = t.keydownListenerCapture, e.keydownTarget.addEventListener("keydown", e.keydownHandler, { capture: e.keydownListenerCapture }), e.keydownHandlerAdded = !0), t = a, "select" === (e = c).input || "radio" === e.input ? Mt(t, e) : ["text", "email", "number", "tel", "textarea"].includes(e.input) && (u(e.inputValue) || p(e.inputValue)) && (De(x()), It(t, e)), xt(c), sn(Ie, c, n), an(r, c), setTimeout(() => { r.container.scrollTop = 0 })
            })
        },
        update: function(t) {
            var e = v(),
            ...
            const o = {};
            Object.keys(t).forEach(e => { mn.isUpdatableParameter(e) ? o[e] = t[e] : a('Invalid parameter to update: "'.concat(e, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js\n\nIf you think this parameter should be updatable, request it here: https://github.com/sweetalert2/sweetalert2/issues/new?template=02_feature_request.md')) }), n = Object.assign({}, n, o), Oe(this, n), ge.innerParams.set(this, n), Object.defineProperties(this, { params: { value: Object.assign({}, this.params, t), writable: !1, enumerable: !0 } })
        },
        _destroy: function() {
            var e = ge.domCache.get(this);
    ...
    let dn;
    class pn {
        constructor(...e) { "undefined" != typeof window && (dn = this, e = Object.freeze(this.constructor.argsToParams(e)), Object.defineProperties(this, { params: { value: e, writable: !1, enumerable: !0, configurable: !0 } }), e = this._main(this.params), ge.promise.set(this, e)) }
        then(e) { const t = ge.promise.get(this); return t.then(e) } finally(e) { const t = ge.promise.get(this); return t.finally(e) }
    }
    Object.assign(pn.prototype, e), Object.assign(pn, Je), Object.keys(e).forEach(t => { pn[t] = function(...e) { if (dn) return dn[t](...e) } }), pn.DismissReason = l, pn.version = "11.1.9";
    const mn = pn;
...
function showToast(str_icon, str_tittle) {
    Toast.fire({
        icon: str_icon,
        title: str_tittle
    });
